...
import { socialEventValidationSchema } from './social-event-validation-schema'
...
const SocialEventDetailForm = ({ event }: Event | any) => {
  ...
  const {
    ...
    resolver: yupResolver(socialEventValidationSchema),
  })
...
export default SocialEventDetailForm
